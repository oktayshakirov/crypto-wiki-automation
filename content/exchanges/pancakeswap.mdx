...
social:
  ...
  youtube: https://www.youtube.com/@PancakeSwap
...
![PancakeSwap AMM diagram showing liquidity pools and swap flows](/images/posts/amm-liquidity-pools-diagram.png)
...
![Wallet connecting to PancakeSwap with multichain network selector visible](/images/posts/wallet-connect-dex-multichain.png)
...
- **Staking and Emissions:** CAKE staking (Syrup Pools) and farm rewards evolve via governance. Understand how emissions, veCAKE, and reward multipliers impact effective yields, especially relative to **[Proof-of-Stake](/posts/what-is-proof-of-stake)** yields on base networks and protocol-level **[staking](/posts/crypto-staking)**.
- **Token Discovery vs. Safety:** Permissionless listings are a feature and a risk. Use verified token lists, check explorers, and remember our primer on avoiding **[crypto scams](/posts/how-to-avoid-crypto-scams)**.
